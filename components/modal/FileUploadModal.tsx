...
export default function FileUploadModal({ onLoad }: FileUploadModalProps) {
  ...
  const onSubmit = async (e: FormEvent) => {
    e.preventDefault();
    if (file && title && title.current) onLoad(file, title.current.value);
  };
